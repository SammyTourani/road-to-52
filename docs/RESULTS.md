...
| 2026-09-14 | gpt2-124m-reference | core | 0.121646 CORE | examples 91037, few-shot per task (0/3/10), nanochat core.yaml, tokenizer gpt2 (tiktoken), block_size 1024, n_tasks 22, harness r52.eval.core, port of nanochat core_eval.py + base_eval.py; wall-clock 19662 s; `python -m r52.eval.core --model models/gpt2-mlx` | 05d3fd7+dirty |
